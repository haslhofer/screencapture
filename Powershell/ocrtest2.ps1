...
Process
{
    ...
    $p = $ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath($q)
    ...
    # Run the OCR
    Await $ocrEngine.RecognizeAsync($softwareBitmap) ([Windows.Media.Ocr.OcrResult]) | ConvertTo-Json -Depth 9 
